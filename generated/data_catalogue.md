...
This document provides a description of the data catalogue for the Combined System Development Services of the LSCP of the Buildings Department. It includes an overview of the database schema, collection statistics, field analysis, and definitions of key terms.
...
This section provides an overview of the database schema, including database statistics and a summary of each collection.
...
| 7        | cases           | Cases related to applications. |
| 8        | oauthtokens     | OAuth tokens for authentication. |
| 9        | sysfilerefs     | System file references. |
| 10       | attachments     | File attachments for applications and cases. |
| 11       | users           | User accounts. |
| 12       | adrblkfilerefs  | Address block file references. |

## Collection Details

The following sections provide detailed information about each collection in the database.
...
> BIGINT:
>
> The BIGINT data type is used to store larger integer value. e.g. from -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807.
>
> NVARCHAR:
>
...
> UNIQUEIDENTIFIER:
>
> A column or local variable of unique identifier data type can be initialized to a value.
>
> BIT:
>
...
> Entity Name:  (To be populated based on entity)
>
> Description: (To be populated based on entity)
