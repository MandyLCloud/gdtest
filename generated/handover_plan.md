...
# 1. Environment Description <a id="environment-description"></a>
...
**(Detailed Equipment and Software Configuration are described in Section 6 and 7)**

# 2. Purpose <a id="purpose"></a>
...
## 2.2 Verification <a id="verification"></a>
...
# 3. Documentation <a id="documentation"></a>
...
**(For details of System Architecture and Functions, please refer to the System Manual)**

# 4. Program Source Code <a id="program-source-code"></a>
...
**(For details of Application Programs, please refer to Program Manual)**

# 5. Administration Accounts Checklist <a id="administration-accounts-checklist"></a>
...
**(For detailed Backup Strategy and Schedule, please refer to Section 8.2, 8.6 and 8.6.3 of the System Manual)**

## 6.2 Database Backup <a id="database-backup"></a>
...
**(For detailed Database Backup Strategy and Administration, please refer to Section 8.6 and 9.2 of the System Manual)**

# 7. Outstanding Items/Issues <a id="outstanding-itemsissues"></a>

Nil.

# 8. Licensed Software <a id="licensed-software"></a>
...
**(For detailed Software Inventories on each machine, please refer to Section 7.2 of the System Manual)**
